...
public class ScanInputAnalyzerTest {
    ...
    public void targetStatsPreserveIpFirstExpansionShape() {
        String raw = "8.8.8.8\nscannerexample.invalid 8.8.8.8\nbad/host\n8.8.0.0/30\n8.8.8.1-8.8.8.3";
        ...
        assertTrue(stats.contains("Preview: 8.8.8.8, scannerexample.invalid, 8.8.0.0/30, 8.8.8.1-8.8.8.3"));
    }
    ...
    public void previewExpandedTargetsSamplesOnlyExpandedForms() {
        List<String> preview = ScanInputAnalyzer.previewExpandedTargets(
                Arrays.asList("8.8.0.0/30", "8.8.8.1-8.8.8.3", "example.com"),
                3,
                (value, index) -> value + "#" + index);

        assertEquals(Arrays.asList("8.8.0.0/30#0", "8.8.8.1-8.8.8.3#1", "example.com"), preview);
    }
}
